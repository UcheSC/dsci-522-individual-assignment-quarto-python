...
We present the standard deviations in @tbl-horses_table.



```{python}
#| label: tbl-horses_table
...
Additionally, note that in @tbl-horses_table we consider the sample standard deviation of the number of horses during the same time span as @fig-horse_pops_plot.
...
@fig-horse_pops_plot_largest_sd
